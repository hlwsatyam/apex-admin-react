...
//                             <h2 className="LoginText">Login</h2>
//                         </div>
//                         <form action="" className='ForOfLogin'>
//                             <div className='DivOflogEmail'>
//                                 <span><MdOutlineMail className='IconOfmail' /></span>
//                                 <input type="email" className="form-control InputOfLog" id="exampleFormControlInput1" placeholder="Username or Email" />
//                             </div>
//                             <div className='DivOflogPass'>
//                                 <span><FaLock className='IconOfmail' /></span>
//                                 <input type="password" className="form-control InputOfLog1" id="exampleFormControlInput1" placeholder="Password" />
//                                 <span><FiEye className='IconOfEye' /></span>
//                             </div>
